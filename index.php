  ...
  <section class="mt-8">
    <div class="container">
      <div class="hero-slider ">
        <div style="background: url(assets/images/slider/slide-1.jpg)no-repeat; background-size: cover; border-radius: .5rem; background-position: center;">
  ...
  <section class="my-lg-14 my-8">
    <div class="container">
      ...
      <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3">
          ...
          <div class="card card-product">
            <div class="card-body">
              ...
              <div class="text-center position-relative">
                ...
                <a href="#!"> <img src="assets/images/products/<?php echo $row['img1'];?>" alt="<?php echo $row['p_title'];?>" class="mb-3 img-fluid"></a>

                <div class="card-product-action">
                  <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal<?php echo $row['p_id'];?>"><i class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i></a>
              ...
              <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small><?php echo $row['cat_name'];?></small></a></div>
              
              <h2 class="fs-6"><a href="pages/shop-single.php?p_id=<?php echo $row['p_id'];?>" class="text-inherit text-decoration-none"><?php echo $row['p_title'];?></a></h2>
              <div>
              ...
              <div class="d-flex justify-content-between align-items-center mt-3">
                <div><span class="text-dark">$<?php echo $row['p_price'];?></span> <span class="text-decoration-line-through text-muted">$<?php echo $row['re_price'];?></span>
                </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="quickViewModal<?php echo $row['p_id'];?>" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
              <div class="modal-body p-8">
                ...
                <div class="row">
                  ...
                  background-image: url(assets/images/products/<?php echo $row['img1'];?>);
                ">
                        <!-- img -->
                      ...
                      <div>
                        <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url(assets/images/products/<?php echo $row['img2'];?>);
                  ">
                          <!-- img -->
                      ...
                      <div>
                        <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url(assets/images/products/<?php echo $row['img3'];?>);
                  ">
                          <!-- img -->
                      ...
                      <div>
                        <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url(assets/images/products/<?php echo $row['img4'];?>);
                  ">
                          <!-- img -->
                  ...
                  <div class="col-lg-6">
                    <div class="ps-lg-8 mt-6 mt-lg-0">
                      ...
                      <h2 class="mb-1 h1"><?php echo $row['p_title'];?></h2>
                      <div class="mb-4">
                      ...
                      <div class="fs-4">
                        <span class="fw-bold text-dark">$<?php echo $row['p_price'];?></span>
                        <span class="text-decoration-line-through text-muted">$<?php echo $row['re_price'];?></span><span><small class="fs-6 ms-2 text-danger"><?php echo round(($row['p_price']/$row['re_price'])*100);?> % Off</small></span>
                      </div>
                      <hr class="my-6">
                      <div class="mb-4">
