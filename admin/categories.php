...
// Fetch Category 
$query = "SELECT *, count(p_id) as cat_count FROM category AS c left join products as p on c.cat_id = p.p_id GROUP BY cat_name order by cat_status";
                  ...
                  <table class="table table-centered table-hover mb-0 text-nowrap table-borderless table-with-checkbox">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="#!"> <img src="../assets/images/icons/<?php echo $row['cat_img'];?>" alt="<?php echo $row['cat_name'];?>"
