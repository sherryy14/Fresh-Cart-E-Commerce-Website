...
<!-- Mirrored from freshcart.codescandy.com/pages/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:39 GMT -->
<head>
...
<div class="border-bottom shadow-sm">
  ...
  <section class="my-lg-14 my-8">
    <div class="container">
      ...
      <input type="password" id="fakePassword" placeholder="Enter Password" name='pass' class="form-control" required >
      <span><i id="passwordToggler"class="bi bi-eye-slash"></i></span>
              ...
              <p class="text-center text-danger"> <?php echo @$failed;?> </p>
              <!-- btn -->
              <div class="col-12 d-grid"> <button type="submit" class="btn btn-primary" name='signin'>Sign In</button>
              </div>
              <!-- link -->
...
<!-- Mirrored from freshcart.codescandy.com/pages/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:40 GMT -->
</html>